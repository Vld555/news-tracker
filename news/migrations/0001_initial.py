# Generated by Django 5.0.2 on 2026-02-19 11:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(help_text='Основная тематика источника', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('daily_reading_limit', models.IntegerField(default=3600, help_text='Лимит чтения в секундах')),
